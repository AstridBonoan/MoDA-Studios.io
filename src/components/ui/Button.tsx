...
const variants = {
  primary:
    'bg-gold text-matte hover:bg-brass border border-gold/30 shadow-lg shadow-gold/10',
  secondary:
    'bg-transparent text-off-white border border-off-white/25 hover:border-gold hover:text-gold',
  outline:
